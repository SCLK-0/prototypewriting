...
function Calendar({ className, classNames, showOutsideDays = true, ...props }: CalendarProps) {
  return (
    <DayPicker
      ...
      className={cn("p-4 pointer-events-auto bg-card rounded-lg", className)}
      classNames={{
        ...
        nav_button: cn(
          ...
          "h-8 w-8 bg-muted/50 p-0 hover:bg-primary hover:text-primary-foreground transition-colors rounded-md",
        ),
        ...
        day_today: "bg-muted text-foreground font-semibold ring-1 ring-primary/30",
        day_outside:
          "day-outside text-muted-foreground/40 aria-selected:bg-primary/30 aria-selected:text-muted-foreground aria-selected:opacity-50",
